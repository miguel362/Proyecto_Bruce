    ...
    return (
        <LayoutRoot>
            <main className=" bg-main h-auto py-10 px-4">
                    ...
                    <table className="table table-xs table-pin-rows table-pin-cols">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td>Pulp Fiction John Travolta; Samuel L. Jackson; Uma Thurman; Tim Roth; Harvey Keitel; Ving Rhames; Amanda Plummer; <b><u>Bruce Willis</u></b>; Eric Stoltz; Rosanna Arquette
                                </td>
                                <td>Ganador
                                </td>
                            </tr>
                ...
                <h2>Independent Spirit Award Film Independent Spirit Awards</h2>
                <table className="table table-xs table-pin-rows table-pin-cols">
                    <tbody><tr>
                        <th>Año
                        </th>
                ...
                <table className="table table-xs table-pin-rows table-pin-cols">
                    <tbody><tr>
                        ...
                        <tr>
                            ...
                            <td>Bruce Willis​ In Country
                            </td>
                            <td>Nominado
                            </td></tr></tbody></table>
                <h2>Goldene Kamera</h2>
                <table className="table table-xs table-pin-rows table-pin-cols">
                    <tbody><tr>
                        <th>Año
                        </th>
                ...
                <table className="table table-xs table-pin-rows table-pin-cols">
                    <tbody><tr>
                        ...
                        <tr>
                            ...
                            <td>Bruce Willis Pulp Fiction Nobody's Fool
                            </td>
                            <td>Nominado
                            </td></tr></tbody></table>
            </main>
