        ...
        <LayoutHome>
            <main className=" bg-main h-auto py-10 px-4">
                <div className='w-3/4 my-0 mx-auto'>
                    ...
                    <figure className="mw-default-size text-center my-5" typeof="mw:File/Thumb"><img className="max-h-full my-0 mx-auto" src="storage/images/Walk_of_Fame.jpg" alt="paseo de la fama" title="estrella" /><figcaption>Estrella del actor en el Paseo de la Fama de Hollywood.</figcaption></figure>
                    ...
                    <div id='premios' className='oculto'>
                        ...
                        <img className="my-0 mx-auto" src="storage/images/peoples.jpg" alt="Bruce y Haley Joel Osment recogiendo galardón People's Choice" title="Bruce y Haley Joel Osment recogiendo galardón People's Choice" />
                        ...
                        <img className="my-0 mx-auto" src="storage/images/pudding.jpg" alt="Bruce disfrazado en el premio Hasty Pudding Man of the year" title="Bruce disfrazado en el premio Hasty Pudding Man of the year" />
